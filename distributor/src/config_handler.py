...
class ConfigHandler:
    ...
    def _load_distributor_bwlimit(self, conf, web):
        """
        Gets the bwlmit for rclone
    ...
    def get_distributor_bwlimit(self):
        """
        Returns the bwlimit for rclone as a string
        """
