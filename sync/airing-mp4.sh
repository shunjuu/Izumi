#!/bin/bash
#/media/9da3/rocalyte/bin/rclone copy /media/9da3/rocalyte/www/rocalyte.ananke/public_html/Public/Nyaa4/ triton-weebs:"Currently Airing Shows [Hardsub]" -v
...
/media/9da3/rocalyte/bin/rclone copy /media/9da3/rocalyte/www/rocalyte.ananke/public_html/Public/Nyaa4/ carmilla-wizo:"Triton Weeaboos Mirror"/"Currently Airing Shows [Hardsub]" -v
