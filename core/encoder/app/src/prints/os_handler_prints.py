class OSHandlerPrints:
    ...
    def __init__(self, colors):
        ...
        # Encoding colors
        encode_color = colors.LCYAN
        self.TEMP_REPLICA_FS = prefix + "Created replica filesystem at: " + \
            encode_color + "{}" + endc
        self.HARDSUB_FILE_NAME = prefix + "Desginating hardsub name to be: " + \
            encode_color + "{}" + endc
        self.HARDSUB_FILE_SIZE = prefix + "New hardsub file size: " + \
            encode_color + "{}" + endc
