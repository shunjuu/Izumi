...
if ".meta" in sys.argv[1]:
    print("Meta file detected, skipping.")
    print("Input: " + str(sys.argv[1]))
    print()
    sys.exit(0)
...
def request(body):
    try:
        ...
        print("Notification sending failed, continuing...")
...
os.system("/media/9da3/rocalyte/private/scripts/sync/airing-mkv.sh")
req_mkv_show = get_show_name(src_dir)
bodyKV = build_body(req_mkv_show, CAS, mkv_fname_clean_notif, src_file_clean_notif, 1)
request(bodyKV)
...
os.system("/media/9da3/rocalyte/private/scripts/sync/airing-mp4.sh")
req_mp4_show = get_show_name(src_dir)
body4 = build_body(req_mp4_show, CASH, mp4_fname_clean_notif, dest_file_clean_notif, 2)
request(body4)

print("Syncing to Wizo Spaces...")
os.system("/media/9da3/rocalyte/private/scripts/sync/wizo-spaces.sh")
...
print("Cleared.")
print()
print("Completed job for: " + mkv_fname)
print()
